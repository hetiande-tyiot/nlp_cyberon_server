...
部署（119_0724_add_2maincategory）：
    cd /home/cyberon2/nlp_cyberon_server/ai/119_0724_add_2maincategory
...
app = FastAPI(title="SopEngine119 API", version="3.0-119_0724_add_2maincategory")
