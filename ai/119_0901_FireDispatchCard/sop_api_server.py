...
部署（119_0901_FireDispatchCard）：
    cd /home/cyberon2/nlp_cyberon_server/ai/119_0901_FireDispatchCard
...
app = FastAPI(title="SopEngine119 API", version="4.0-119_0901_FireDispatchCard")
