        ...
        *,
        ...
        if location_type == "address":
            ...
            if result.valid is False:
                reason = addrcheck_failure_reason(result.api_reason)
        ...
        if location_type == "intersection":
            ...
            with self._case_lock:
                self.case.address = rebuilt
            status, _hint = verify_address_status(rebuilt, "intersection")
            if status is True:
        ...
        if location_type == "highway":
            ...
            status, _hint = verify_address_status(complete, "highway")
            if status is True:
                self._set_address_validation("valid")
                return True, "", False
            if status is False:
