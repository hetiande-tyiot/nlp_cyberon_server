...
class CaseInfo119:
    ...
    fire_category:       Optional[str] = None  # 建築物/工廠/車輛/露天野外
    ...
    #   火警：火警_location → 火警_location_confirm → 火警_initial_1..4
    #   → 火警_category → 火警_building_* | 火警_factory_* | 火警_vehicle_*
    #   | 火警_outdoor_* → 火警_summary_confirm → 火警_caller_info → completed
